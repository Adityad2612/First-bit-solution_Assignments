...
class CarTest {
	...
	if(c1.getPrice() > c2.getPrice())
	{
		...
		Car c5 = new Car(brand,model,color,price,fc);
		c5.display();

        System.out.println("Brand: " + c1.brand +"Model: " + c1.model +"Price: " + c1.price +"Color: " + c1.color +"Fuel Capacity: " + c1.fuelCapacity + "liters");
    	} // main ends here
