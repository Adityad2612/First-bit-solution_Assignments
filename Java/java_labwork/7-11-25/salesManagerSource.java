...
class SalesManager {
	...
	SalesManager(int i,String n,double s,double ince,double t)
	{
		System.out.println();
		this.id=i;
		this.name=n;
...
class SalesManagerTest {
	...
	SalesManager sm3 = new SalesManager();
	SalesManager sm4 = new SalesManager(405,"Sumit",55000,7500,500000);
	...
	System.out.println("Enter Id:");
		...
		SalesManager sm5 = new SalesManager(Id,name,salary,incentive,target);
		sm5.display();

		SalesManager[] arr = new SalesManager[3];

		arr[0] = new SalesManager();
		arr[1] = new SalesManager(110,"aditya",30000,7500,1000000);
		arr[2] = new SalesManager(111,"harsh",35000,7500,1000000);
