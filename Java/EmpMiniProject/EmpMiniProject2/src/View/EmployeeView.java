		...
		do {
			...
			case 4:
             ...
             case 5:
					...
					System.out.println("4. Commission (HR only)");
					System.out.println("5. Allowance (Admin only)");
					System.out.println("6. Target (Sales Manager only)");
					System.out.println("7. Incentive (Sales Manager only)");
					System.out.print("Enter your choice: ");
					int sortChoice = sc.nextInt();
					ec.sortEmployees(sortChoice);
					ec.displayAll();
					break;
			case 6:
				ec.displayAll();
