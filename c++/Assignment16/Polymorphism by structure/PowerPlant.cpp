...
public:
    ...
    PowerPlant(int id, string name, string loc,
               double cap, int emp, double prod)
    {
        plantId = id;
        plantName = name;
        location = loc;
...
// -------------------- SolarPlant --------------------
struct SolarPlant : public PowerPlant
{
protected:
    int solarPanels;
    double areaCovered;
...
public:
    ...
    SolarPlant(int id, string name, string loc,
               double cap, int emp, double prod,
...
// -------------------- HydroPlant --------------------
struct HydroPlant : public PowerPlant
{
protected:
...
public:
    ...
    HydroPlant(int id, string name, string loc,
               double cap, int emp, double prod,
...
// -------------------- WindPlant --------------------
struct WindPlant : public PowerPlant
{
protected:
    int windTurbines;
...
public:
    ...
    WindPlant(int id, string name, string loc,
              double cap, int emp, double prod,
